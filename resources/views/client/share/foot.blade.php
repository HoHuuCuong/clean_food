                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                        <div class="footer-widget-inner">
                            ...
                            <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                ...
                                <li class="footer-menu-item"><a href="blog.html">Tuyển dụng</a></li>
                                <li class="footer-menu-item"><a href="about-us.html">Tổ chức</a></li>
                                <li class="footer-menu-item"><a href="about-us.html">Tập đoàn</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                        <div class="footer-widget-inner">
                            ...
                            <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                ...
                                <li class="footer-menu-item"><a href="about-us.html">Quy định đặt hàng</a></li>
                                <li class="footer-menu-item"><a href="collection-left-sidebar.html">Vận chuyển</a></li>
                                <li class="footer-menu-item"><a href="collection-left-sidebar.html">Thanh toán</a></li>
                                <li class="footer-menu-item"><a href="collection-left-sidebar.html">Góp ý</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                        <div class="footer-widget-inner">
                            ...
                            <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                <li class="footer-menu-item"><a href="faq.html">Hướng dẫn mua hàng</a></li>
                                <li class="footer-menu-item"><a href="about-us.html">Hướng dẫn đăng kí</a></li>
                                <li class="footer-menu-item"><a href="about-us.html">Khôi phục mật khẩu</a></li>
                                <li class="footer-menu-item"><a href="contact.html">Quản lý đơn hàng</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-5 col-md-6 col-12 footer-widget">
                        <div class="footer-widget-inner">
                            <h4 class="footer-logo">
                                <a href="/"><img src="/assets_client//img/hai.png" alt="bisum"></a>
                            </h4>
                            <div class="footer-newsletter">
                                <p class="footer-text mb-3">Thực phẩm sạch chất lượng cao.</p>
                                <div class="newsletter-wrapper">
                                    <form action="#" class="footer-newsletter-form d-flex align-items-center">
                                        ...
                                        <button class="footer-newsletter-btn" type="submit">Đăng Kí</button>
                                    </form>
                                </div>
