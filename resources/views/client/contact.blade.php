                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="contact-item">
                                ...
                                <div class="contact-details">
                                    ...
                                    <a class="contact-info" href="mailto:info@example.com">thucphamsach123@gmail.com</a>
                                    <a class="contact-info" href="mailto:info2@example.com">quanluong2001@gmail.com</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="contact-item">
                                ...
                                <div class="contact-details">
                                    <h2 class="contact-title">Địa chỉ cửa hàng</h2>
                                    <p class="contact-info">03 Quang Trung - Thanh Khê - Đà Nẵng</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="contact-item">
                                ...
                                <div class="contact-details">
                                    ...
                                    <a class="contact-info" href="tel:(201) 555-0124">(+84) 379705128</a>
                                    <a class="contact-info" href="tel:(307) 555-0133">(+84) 23456789</a>
                                </div>
                            </div>
                        </div>
